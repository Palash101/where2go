  ...
  const renderInputEl = (icon, type, key) => {
    ...
    return (
      <Box>
        ...
        />
        <DeleteIcon onClick={() => removeElFromArray(key)} />
      </Box>
    )
  }
    ...
    return (
      <Fragment>
        ...
        >
          <MenuItem
            sx={{ p: 0 }}
            onClick={() => addInputElToArray('email', 'email')}
          >
            <Box sx={styles}>
          ...
          <MenuItem
            sx={{ p: 0 }}
            onClick={() => addInputElToArray('phone', 'number')}
          >
            <Box sx={styles}>
          ...
          <MenuItem
            sx={{ p: 0 }}
            onClick={() => addInputElToArray('whatsapp', 'number')}
          >
            <Box sx={styles}>
          ...
          <MenuItem
            sx={{ p: 0 }}
            onClick={() => addInputElToArray('instagram', 'text')}
          >
            <Box sx={styles}>
      ...
      <Grid container spacing={5}>
        <Grid item sx={{ paddingBottom: '1.25rem' }} xs={12} sm={6}>
          ...
          <Dialog maxWidth="sm" fullWidth open={open} onClose={handleClose}>
            ...
            <Typography padding="10px" component="p">
              Add contact details for the visitors to your event page and your
              event attendees.
            </Typography>
            <DialogContent>
              <Box sx={{ width: '100%' }}>
