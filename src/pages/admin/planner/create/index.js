          ...
          <ul className="seatList">
            ...
            <li>
              ...
              <div>
                <Button
                  type="button"
                  onClick={() => setColor('#24262b')}
                  variant={myColor === '#24262b' ? 'contained' : 'outlined'}
                  color="secondary"
                  size="small"
                >
                  Delete
                ...
                <Button
                  ...
                  variant={myColor === 'black' ? 'contained' : 'outlined'}
                  color="secondary"
                  size="small"
                >
                  Undo
            ...
            <li>
              ...
              <div className="colors">
                <a
                  ...
                  color="red"
                  className={myColor === 'red' ? 'active' : 'notactive'}
                  onClick={() => setColor('red')}
                ></a>
                <a
                  style={{ backgroundColor: 'green' }}
                  color="green"
                  className={myColor === 'green' ? 'active' : 'notactive'}
                  onClick={() => setColor('green')}
                ></a>
                <a
                  style={{ backgroundColor: 'blue' }}
                  color="blue"
                  className={myColor === 'blue' ? 'active' : 'notactive'}
                  onClick={() => setColor('blue')}
                ></a>
                <a
                  style={{ backgroundColor: 'yellow' }}
                  color="yellow"
                  className={myColor === 'yellow' ? 'active' : 'notactive'}
                  onClick={() => setColor('yellow')}
                ></a>
                <a
                  style={{ backgroundColor: 'black' }}
                  color="black"
                  className={myColor === 'black' ? 'active' : 'notactive'}
                  onClick={() => setColor('black')}
                ></a>
                <a
                  style={{ backgroundColor: 'purple' }}
                  color="purple"
                  className={myColor === 'purple' ? 'active' : 'notactive'}
                  onClick={() => setColor('purple')}
                ></a>
                <a
                  style={{ backgroundColor: 'orange' }}
                  color="orange"
                  className={myColor === 'orange' ? 'active' : 'notactive'}
            ...
            <svg width="100%" height="100%" fill="#24262b">
              <g fill="black">
                ...
                <svg>
                  <rect
                    fill="#40444d"
                    width={mapValue.stage.width}
                    height={mapValue.stage.height}
                    rx="5"
                    ry="5"
                    x={mapValue.stage.xStartPoistion}
                    y="70"
                  ></rect>
                  <text
                    x="45%"
